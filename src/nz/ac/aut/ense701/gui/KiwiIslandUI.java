    ...
    implements GameEventListener
{
    ...
    public void gameStateChanged(List<EventName> events)
    {
        ...
        if ( game.getState() == GameState.LOST )
        {
            ...
            game.createNewGame();
            ((OutputWindow)outputWindow).resetOutputWindow();
        }
    ...
    private void update(List<EventName> events)
    {
        ...
        ((OutputWindow)outputWindow).updateWindowText(events);
    }
    ...
    private void initComponents() {
        ...
        lblKiwisSaved = new javax.swing.JLabel();
        txtKiwisSaved = new javax.swing.JLabel();
        ...
        lblKiwisSaved.setText("Kiwis Saved :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        pnlPlayerData.add(lblKiwisSaved, gridBagConstraints);

        txtKiwisSaved.setText("0");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 5;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        pnlPlayerData.add(txtKiwisSaved, gridBagConstraints);
