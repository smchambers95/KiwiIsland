 ...
 * @author Marc Tucker
 */
public class AIPredatorController extends AIController {
    private static final int MIN_COOLDOWN = 5000;
    private static final int MAX_COOLDOWN = 10000;
    
    Random rnd;
    
    public AIPredatorController(Game game, Fauna fauna, boolean active) {
    ...
    public void run() {
        ...
        while(!kill){
            ...
            try {
                ...
                Logger.getLogger(AIPredatorController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
